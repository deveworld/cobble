...
**✨ Version 0.5.4** - Bug fixes for pack format validation and title commands | Minecraft 1.21.9+ compatible

## ⚠️ Pre-release Notice

**Cobble is currently in active development (v0.5.4 Pre-Alpha).** While we've implemented many features and extensive tests, the project may contain bugs and unexpected behavior. Features and APIs may change between releases.
