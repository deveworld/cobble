...
**✨ Version 0.5.9** - Critical bug fixes: zero-length loops, boolean/expression parameters, JSON array handling, temp objective tracking | Minecraft 1.21.9+ compatible

## ⚠️ Pre-release Notice

**Cobble is currently in active development (v0.5.9 Pre-Alpha).** While we've implemented many features and extensive tests, the project may contain bugs and unexpected behavior. Features and APIs may change between releases.
