...
Minecraft's `$(param_name)` macro syntax when needed. Cobble v0.7.1 targets
...
Cobble v0.7.1 requires **Minecraft Java Edition 26.1.2** and pack format **101.1**. Older Minecraft versions are intentionally not supported by this release.
