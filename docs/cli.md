...
- `--pack-format <NUM>` - Set the pack format version (default: `101.1`; Cobble v0.6.3-a0 requires Minecraft Java Edition 26.1.2)
...
Cobble v0.6.3-a0 targets Minecraft Java Edition 26.1.2 and rejects other pack formats. This keeps generated data packs on the command and data pack schema version the compiler is tested against.
...
Note: Cobble v0.6.3-a0 requires Minecraft Java Edition 26.1.2 and pack format 101.1.
